...
rsa_key = RSA.generate(2048)            # RSA keypair
...
ecc_key = ECC.generate(curve='P-256')   # ECC keypair
...
# RSA hybrid encryption (AES + RSA for AES key)
...
# ECC hybrid encryption (AES + ECC signature)
